Public Class AddUserForm
    ...
    'This function will invoke on submitting add user form 
    Public Function Adduser(sender As Object, e As EventArgs) Handles btnAddUser.Click 'handels btnID.Click event
        ...
        Dim result = Userservice.Value.saveUserData(UserDetails)
